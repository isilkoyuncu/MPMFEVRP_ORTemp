...
{
    abstract class AbstractProblem : IProblem
    {
        ...
        public ObjectiveFunctionTypes ObjectiveFunctionType => throw new NotImplementedException();

        public List<Job> Jobs => throw new NotImplementedException();

        public AbstractProblem()
        {

        }
        protected void constructAbstractProblem(IReader reader)
        {
