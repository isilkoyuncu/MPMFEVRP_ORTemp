...
namespace MPMFEVRP.Implementations.Problems.Interfaces_and_Bases
{
    public abstract class EVvsGDV_Problem : ProblemBase
    {
        ...
        {
            problemCharacteristics.AddParameter(new InputOrOutputParameter(ParameterID.PRB_NUM_EV, "Available # of EVS", "1"));
            ...
            problemCharacteristics.AddParameter(new InputOrOutputParameter(ParameterID.PRB_NUM_GDV, "Available # of GDVs", "10"));
            ...
            problemCharacteristics.AddParameter(new InputOrOutputParameter(ParameterID.PRB_CREATETSPSOLVERS, "Create TSP Solvers", new List<object>() { true, false }, false, UserInputObjectType.CheckBox));
            problemCharacteristics.AddParameter(new InputOrOutputParameter(ParameterID.PRB_CREATEEXPLOITINGTSPSOLVER, "Create Exploiting TSP Solver", new List<object>() { true, false }, true, UserInputObjectType.CheckBox));
