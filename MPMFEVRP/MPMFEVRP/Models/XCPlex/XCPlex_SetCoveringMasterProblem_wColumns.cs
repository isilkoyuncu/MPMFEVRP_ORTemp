...
{
    class XCPlex_SetCoveringMasterProblem_wColumns : XCPlexBase
    {
        ...
        public XCPlex_SetCoveringMasterProblem_wColumns() { }

        public XCPlex_SetCoveringMasterProblem_wColumns(EVvsGDV_ProblemModel theProblemModel, XCPlexParameters xCplexParam, CustomerSetList cs_List = null, bool noGDVUnlimitedEV = false)
        {
        ...
        {
            return "Master Problem: Set Covering";
        }
