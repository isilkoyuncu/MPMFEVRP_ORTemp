...
namespace MPMFEVRPTests.TSPSolverTests
{
    ...
    public class NodeDuplicatingWithoutU
    {
        ...
        {
            //Read the file #1
            MPMFEVRP.Implementations.Problems.Readers.KoyuncuYavuzReader kyr = new MPMFEVRP.Implementations.Problems.Readers.KoyuncuYavuzReader("C:\\Users\\myavuz\\Google Drive\\KoyuncuYavuzInstances\\Instances for unit and integration tests\\10c3sU1_0(0,0+0+0)_4(4+0+0)_E60.txt");
            kyr.Read();
